...
While =syntax-rules= is a lambda expression, that call =syntax-case=
to return a syntax object.
...
** with-syntax
This is often used to nest syntax. It is like =let=
#+BEGIN_SRC racket
