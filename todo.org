...
** STARTED download project for all languages (with size difference)
** TODO add commit number
** TODO add feature: has wiki, has page, create at, last update (can all be got from json file)
** TODO change number star into category (discretize)
** STARTED do the back-end analysis
** TODO add fork number
** TODO add watcher number
** write slides
** write report
